...
<div class="container">
    <c:if test="${sessionScope.cart.cartProducts.size() > 0}">
        ...
        <c:forEach var="p" items="${sessionScope.cart.cartProducts}">
            <tr>
                ...
                <td>
                    <form method="post" action="/guest/cart/delete/<c:out value="${p.key.id}"/>">
        ...
        <div class="mt-4" align="center">
            <p class="text-center"><fmt:message key="login_to_order"/></p>
            <a href="/login" class="btn btn-secondary"><fmt:message key="login"/></a>
        </div>
    </c:if>
    <c:if test="${sessionScope.cart.cartProducts.size()==0}">
    ...
    <div class="my-2" align="center">
        <a href="/guest/products" class="btn btn-light"><fmt:message key="back_to_products"/> </a>
    </div>
</div>
