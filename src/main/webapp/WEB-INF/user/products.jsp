    ...
    <nav>
        <ul class="pagination d-flex justify-content-center">
            <li class="page-item <c:out value="${currentPage <= 1 ? 'disabled' : ''}"/>">
                <a class="page-link"
                   href="/user/products?size=${size}&page=${currentPage - 1}&sortcriteria=${chosen_sortcriteria}&material=${chosen_material}&category=${chosen_category}&price_from=${chosen_price_from}&price_to=${requestScope.chosen_price_to}">
            ...
            <c:if test="${requestScope.pageNumbers.size() > 0}">
                <c:forEach var="pageNumber" items="${pageNumbers}">
                    <li class="page-item <c:out value="${currentPage == pageNumber ? 'active' : ''}"/>">
                        <a class="page-link"
                           href="/user/products?size=${size}&page=${pageNumber}&sortcriteria=${chosen_sortcriteria}&material=${chosen_material}&category=${chosen_category}&price_from=${chosen_price_from}&price_to=${chosen_price_to}">
            ...
            <li class="page-item <c:out value="${currentPage >= products.size() ? 'disabled' : ''}"/>">
                <a class="page-link"
                   href="/user/products?size=${size}&page=${currentPage + 1}&sortcriteria=${chosen_sortcriteria}&material=${chosen_material}&category=${chosen_category}&price_from=${chosen_price_from}&price_to=${chosen_price_to}">
